...
6. Insert the oracle id, job id, and fee (wei) in the contract (a full list of available networks is available value  [here](network.md).  The fee should be 1000000000000 (10*16 wei).
